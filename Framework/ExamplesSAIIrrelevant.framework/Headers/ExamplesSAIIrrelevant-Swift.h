...
SWIFT_CLASS("_TtC21ExamplesSAIIrrelevant48AbstractClassificationResultDetailViewController")
@interface AbstractClassificationResultDetailViewController : UIViewController <UITableViewDataSource>
- (void)viewDidLoad;
...
- (void)loadNetworkFromUrl:(NSURL * _Nonnull)url;
...
SWIFT_CLASS("_TtC21ExamplesSAIIrrelevant9SAIButton")
@interface SAIButton : UIButton
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC21ExamplesSAIIrrelevant21SAICircleProgressView")
@interface SAICircleProgressView : UIView
